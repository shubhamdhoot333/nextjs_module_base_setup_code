...
import { finalOrder } from "@/redux/slices/orderSlice";
...
const handleorder = async (cartData) =>{
  dispatch(finalOrder(cartData));
  router.push('/orders')
              ...
              {cartData.length > 0 ? (
                <>
                  ...
                  <div>
                      ...
                      <button 
                        onClick={() => handleorder(cartData) }
                      className="font-bold my-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">
                        Buy Now
                      </button>
                    </div>
                </>
