...
import { increment, decrement, incrementByAmount,addCardData  } from "@/redux/slices/counterSlice";
import { addtocarddata } from "@/redux/slices/addtocardSlice";
function Card({ value }) {
  ...
  const handleAddToCart = async (value) => {
       dispatch(increment());
       dispatch(addtocarddata({...value,qty,size,finalPrice}));
  };
